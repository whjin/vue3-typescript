 ...
 * color: 阴影颜色
 */
export interface MYAPPElementShadow {
  h: number;
  v: number;
  blur: number;
  color: string;
 ...
 * color?: 边框颜色
 */
export interface MYAPPElementOutline {
  style?: 'dashed' | 'solid';
  width?: number;
  color?: string;
}
 ...
 */
export interface MYAPPElementLink {
  type: 'web' | 'slide';
  target: string;
}
 ...
 * vertical?: 竖向文本
 */
export interface MYAPPTextElement extends MYAPPBaseElement {
  type: 'text';
  content: string;
  defaultFontName: string;
  defaultColor: string;
  outline?: MYAPPElementOutline;
  fill?: string;
  lineHeight?: number;
  wordSpace?: number;
  opacity?: number;
  shadow?: MYAPPElementShadow;
 ...
 * shadow?: 阴影
 */
export interface MYAPPImageElement extends MYAPPBaseElement {
  type: 'image';
  fixedRatio: boolean;
  src: string;
  outline?: MYAPPElementOutline;
 ...
 * keypoint?: 关键点位置百分比
 */
export interface MYAPPShapeElement extends MYAPPBaseElement {
  type: 'shape';
 ...
 */
export interface MYAPPLineElement extends Omit<MYAPPBaseElement, 'height' | 'rotate'> {
  type: 'line';
  start: [number, number];
  end: [number, number];
  style: 'solid' | 'dashed';
 ...
 * legend?: 图例/位置
 */
export interface MYAPPChartElement extends MYAPPBaseElement {
  type: 'chart';
  fill?: string;
  chartType: ChartType;
  data: ChartData;
 ...
 * data: 表格数据
 */
export interface MYAPPTableElement extends MYAPPBaseElement {
  type: 'table';
  outline: MYAPPElementOutline;
  theme?: TableTheme;
  colWidths: number[];
 ...
 * fixedRatio: 固定形状宽高比例
 */
export interface MYAPPLatexElement extends MYAPPBaseElement {
  type: 'latex';
  latex: string;
  path: string;
  color: string;
 ...
 */
export interface MYAPPVideoElement extends MYAPPBaseElement {
  type: 'video';
  src: string;
  autoplay: boolean;
  poster?: string;
 ...
 */
export interface MYAPPAudioElement extends MYAPPBaseElement {
  type: 'audio';
  fixedRatio: boolean;
  color: string;
  loop: boolean;
...
export type MYAPPElement = MYAPPTextElement | MYAPPImageElement | MYAPPShapeElement | MYAPPLineElement | MYAPPChartElement | MYAPPTableElement | MYAPPLatexElement | MYAPPVideoElement | MYAPPAudioElement;
 ...
 */
export interface MYAPPAnimation {
  id: string;
  elId: string;
  effect: string;
